            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'ads_right') { ?>
                    <option value="ads_right" selected="selected"><?php echo $text_ads_right; ?></option>
                    <?php } else { ?>
                    <option value="ads_right"><?php echo $text_ads_right; ?></option>
                    <?php } ?>

					 <?php if ($layout_module['position'] == 'header_right') { ?>
                    <option value="header_right" selected="selected">Header Right</option>
                    <?php } else { ?>
...
function addModule() {
    ...
    html += '    <option value="ads_right"><?php echo $text_ads_right; ?></option>';
	html += '    <option value="header_right">Header Right</option>';
	html += '    <option value="header_left">Header Left</option>';
    html += '  </select></td>';
