...
<head>
    ...
    $listcssjs[] = 'catalog/view/theme/'.$config->get( 'config_template' ).'/js/bootstrap.min.js';
...
$.src="//v2.zopim.com/?4915E3VrpweniFtKustOkTFIjJ7XL6E8";z.t=+new Date;$.
...
<div class="fixed-body">
		...
		<header>
					...
					<div class="row">
						<div class="col-sm-6 hidden-xs">
							<div id="welcome">
								...
								<?php if($logged) { ?>
								Welcome
								<a href="<?php echo $account; ?>" style="font-weight: 600;margin-left: 10px"><?php echo $firstname;?></a>

								(<a href="<?php echo $logout; ?>"><?php echo $text_logout;?></a>)

								|<a href="<?php echo $wishlist; ?>" id="wishlist-total" style="margin-left: 10px;margin-right: 10px;"><?php echo $text_wishlist; ?></a>

								|<a href="<?php echo $shopping_cart; ?>" style="margin-left: 10px;margin-right: 10px;"><?php echo $text_shopping_cart; ?></a>

								|<a href="<?php echo $checkout; ?>" style="margin-left: 10px;margin-right: 10px;"><?php echo $text_checkout; ?></a>

								<?php }else{ ?>
								Welcome Guest, Please
								<a href="<?php echo $register; ?>" style="font-weight: 600"><?php echo $text_register; ?></a>
								Or
								<a href="<?php echo $login; ?>" style="font-weight: 600"><?php echo $text_login; ?></a>
										<?php } ?>
							</div>
						</div>
						...
						<div class="col-sm-6 col-xs-12 hidden-xs">
								<div class="quick-access">
									<div class="dropdown  my-account currency" style="font-weight: 600">
										<?php echo $currency; ?>
									</div>
									<div class="dropdown  my-account" style="font-weight: 600">&nbsp;&or;</div>
									<div class="dropdown  my-account" style="padding-left:10px">|</div>

									<div class="dropdown  my-account language">
										<?php echo $language; ?>
									</div>

									<div class="dropdown  my-account" style="padding-left:10px;font-weight:600">
			...
			<div class="visible-xs col-xs-12" style="text-align:center;display:inline-block; margin-bottom:20px;">
					...
					?>
					<!--<div class="container horizontal"> yuxing-->
																	...
																	<div class="menu">
																		<ul>
																		  ...
																		  <?php if (isset($category['children'][$i])) { ?>
																			<?php if (strstr($category['children'][$i]['href'],"60_20") || strstr($category['children'][$i]['href'],"60_25")){ ?><!--yuxing-->
																				<li><a href="<?php echo $category['children'][$i]['href']; ?>" onclick="window.location = '<?php echo $category['children'][$i]['href']; ?>';"><h6><?php echo $category['children'][$i]['name']; ?></h6></a></li>
																			<?php }else{ ?>
