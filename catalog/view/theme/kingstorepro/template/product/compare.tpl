...
<table class="table table-bordered">
  ...
  <tr>
    <td></td>
    <?php foreach ($products as $product) { ?>
    <td><input type="button" value="<?php echo $button_cart; ?>" class="button" onclick="cart.add('<?php echo $product['product_id']; ?>');" />
      <a href="<?php echo $product['remove']; ?>" class="button"><?php echo $button_remove; ?></a></td>
    <?php } ?>
  </tr>
</table>
</div>
