...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['tab_sizechart']            = $this->language->get('tab_sizechart');
			$data['tab_colorchart']           = $this->language->get('tab_colorchart');;
			$data['tab_measure']              = $this->language->get('tab_measure');;
			$data['tab_shippingmethods']      = $this->language->get('tab_shippingmethods');;
			...
			if ($product_info['image']) {
				...
				$data['origin'] = $this->config->get('config_url') . $product_info['image'];
			} else {
				$data['popup'] = '';
				$data['origin'] = '';
			}
			...
			/*add product image to images yuxing*/
			$data['images'][] = array(
